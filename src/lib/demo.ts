...
export const worldTeachersDayCampaign: Campaign = {
  id: "00000000-0000-4000-8000-000000000201",
  name: "World Teachers’ Day 2026",
  slug: "world-teachers-day-2026",
  short_code: "teachers26",
  organization_name: "Global Education Community",
  title: "Celebrate the Teachers Who Shape Tomorrow",
  description:
    "Create a personal World Teachers’ Day frame to thank the educators who inspire, guide, and empower every generation.",
  logo_url: "",
  cover_url: "/frames/world-teachers-day-2026.png",
  primary_color: "#0a4d8f",
  secondary_color: "#f7f3e8",
  accent_color: "#e5b93f",
  event_date_text: "October 5, 2026",
  location: "Worldwide",
  status: "published",
  start_at: null,
  end_at: null,
  ...
  allow_after_end: false,
  share_text:
    "I’m celebrating the teachers who inspire, educate, and empower us this World Teachers’ Day, October 5, 2026.",
  privacy_text: PRIVACY,
  cta_text: "Create My Teachers’ Day Frame",
  filename_prefix: "World-Teachers-Day-2026",
  thank_you_text: "Thank you for celebrating the educators who shape tomorrow.",
  name_position: "bottom",
  name_color: "#ffffff",
  name_font: "Arial",
  name_font_size: 70,
  frames: [
    {
      ...
      name: "Teaching Shapes Tomorrow",
      frame_url: "/frames/world-teachers-day-2026.png",
      thumbnail_url: "/frames/world-teachers-day-2026.png",
      sort_order: 0,
      is_active: true,
    },
  ],
...
export const worldMentalHealthDayCampaign: Campaign = {
  id: "00000000-0000-4000-8000-000000000301",
  name: "World Mental Health Day 2026",
  slug: "world-mental-health-day-2026",
  short_code: "mind26",
  organization_name: "Global Wellbeing Community",
  title: "You Are Not Alone",
  description:
    "Share a personal World Mental Health Day frame and help make kindness, connection, and open conversations more visible.",
  logo_url: "",
  cover_url: "/frames/world-mental-health-day-2026.png",
  primary_color: "#147e78",
  secondary_color: "#eef9f6",
  accent_color: "#62b98d",
  event_date_text: "October 10, 2026",
  location: "Worldwide",
  status: "published",
  start_at: null,
  end_at: null,
  ...
  allow_after_end: false,
  share_text:
    "You are not alone. I’m supporting kindness, connection, and better mental health this World Mental Health Day, October 10, 2026.",
  privacy_text: PRIVACY,
  cta_text: "Create My Mental Health Day Frame",
  filename_prefix: "World-Mental-Health-Day-2026",
  thank_you_text: "Thank you for helping make mental health support more visible.",
  name_position: "bottom",
  name_color: "#ffffff",
  name_font: "Arial",
  name_font_size: 70,
  frames: [
    {
      ...
      frame_url: "/frames/world-mental-health-day-2026.png",
      thumbnail_url: "/frames/world-mental-health-day-2026.png",
      sort_order: 0,
      is_active: true,
    },
  ],
...
export const demoCampaigns = [
  demoCampaign,
  worldAnimalDayCampaign,
  worldTeachersDayCampaign,
  worldMentalHealthDayCampaign,
];
